...
const ringsCollection = [
  {
    ...
    alt: "Eternal Diamond Ring",
    price: "$2,500",
    description: "Eternal Diamond Ring",
  },
  {
    href: "/products/rings/ring2",
    src: "/image/classic-gold-necklace.jpg",
    alt: "Classic Gold Necklace",
    price: "$1,800",
    description: "Classic Gold Necklace",
  },
  {
    href: "/products/rings/ring3",
    src: "/image/elegant-tennis-bracelet.jpg",
    alt: "Elegant Tennis Bracelet",
    price: "$3,200",
...
const RingsCollection = () => (
  ...
  >
    ...
    <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-x-8 gap-y-8 px-4 sm:px-0">
      {ringsCollection.map(({ href, src, alt, price, description }, index) => (
        <Link
          key={index}
          href={href}
